...
public class GUIVisualization extends JFrame {
    ...
    public GUIVisualization(String _plotType, List<Integer> _dataPointsX, List<Long> _dataPointsY, String title) {
        
        this.plotType = _plotType; // Set the plot type
        this.dataPointsX = _dataPointsX; // Set the x-axis data points
        this.dataPointsY = _dataPointsY; // Set the y-axis data points

        setTitle(title); // Set the title of the window according to operation
